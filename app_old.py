...
def create_path(a, b):
    ...
    if (
        ...
        st.markdown(
            "[![Learn How Capital Market Works](https://la-course-recommendation-engine.s3.ap-south-1.amazonaws.com/Learn+How+Capital+Market+Works.jpeg)](https://learnapp.com/courses/learn-how-capital-markets-work/topics/trailer?locale=en-us)"
        )
        st.write("")
